...
<div class="scrollmenu">
  <a class ="one" href="cartmanage2.php"><img src="images/cart.png" alt="" id="logo" style="width:42px;height:42px;"><br>จัดการระบบตะกร้าสินค้า</a>
  <a class ="one"href="webboard2.php"><img src="images/webboard.png" alt="" id="logo" style="width:80px;height:42px;"><br>webboard</a>
  <a class ="one"href="cart2.php"><img src="images/shop.png" alt="" id="logo" style="width:50px;height:42px;"><br>shop</a>
...
<div class="container" style="width:100%">
  ...
  <table class="container" border=5px>
    ...
    <tr>
      ...
      <td><a class="btn-simple" href="cart2.php?action=empty&sku=<?php print $key?>">ลบ</a></td>
	  <td><a class="btn-simple" href="cart2.php?action=emptyall&sku=<?php print $key?>">ล้าง</a></td>
    </tr>	
	...
	<form method="post" action="checkbill2.php">
      ...
      <div >
        <div> <img src="<?php print $product['image']?>" alt="Lights">
          <div>
            ...
            <form method="post" action="cart2.php?action=addcart">
              <p style="text-align:center;color:#04B745;">
				<input type ="number" min="1" name = "qtya"required></input><br><br>
