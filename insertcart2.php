...
$sku = $_POST['sku'];
$price = $_POST['price'];
$insert = "INSERT INTO `products`(`name`, `sku`, `price`, `image`) VALUES ('$name', '$sku', $price, '');";
...
<form action="insertcart2.php" method="post">
  ...
  <div class="container">
	...
	<label for="psw"><b>product_id</b></label>
    <input type="text"  name="sku" value ="" required>
	
	<label for="permission"><b>price</b></label>
    <input type="text"  name="price" value ="" required>
        
    <button type="submit" name="submit">insert</button>
	<a href="cartmanage2.php" style="font-size:14px; text-align: center">back</a>
  </div>
</form>
