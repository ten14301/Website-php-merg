...
if(isset($_POST['submit'])){
	$update = "update user set id=$ide, name='$name', password='$password', permission='$permission' where id = $ide;";
	mysqli_query($conn,$update) or die ("$id,$name,$password,$permission");
...
<form action="edit.php" method="post">
  ...
  <div class="container">
    ...
    <input type="text"  name="id" value ="<?php echo $data['id'];?>" required>
    ...
    <input type="text"  name="permission" value ="<?php echo $data['permission'];?>" required>
